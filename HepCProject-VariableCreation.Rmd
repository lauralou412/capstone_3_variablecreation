...
encounter_variables <- encounter_variables[-c(15)]
...
encounter_variables <- encounter_variables[-c(16)]
...
#rename column names
colnames(enc_type_freq_table)[6:54] <- paste("FREQ_ENC_TYPE", colnames(enc_type_freq_table[,c(6:54)]), sep = "_")
...
names(flat_file)
  ...
  #Average HEDIS PROC codes = 801 - 859
  #Binary HEDIS PROC codes = 860 - 918
  #Totals and Averages on Encounter Type = 919 - 968
  #Insurance = 969 - 970
