...
library(eeptools)
## DOB ##
pts_demo$DOB[is.na(pts_demo$DOB)] <- Sys.Date()
pts_demo$age_T0 <- age_calc(dob = pts_demo$DOB, enddate = Sys.Date(), units = "years")
...
patients[,11:66][is.na(patients[,11:66])] <- 0  #changed this line!!!!!!
...
# chanage NA's to zeros
patients[,67:146][is.na(patients[,67:146])] <- 0
