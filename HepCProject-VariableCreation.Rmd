...
length(unique(hep_c_icd_dx$PATIENT_ID)) #unique patient id's #3707
...
dim(pt_icd_codes)#8,255,476
dim(hep_c_project_HEDIS_icd_codes)#108
dim(pt_icd_codes_value_sets)#642955
...
all_pts_icd_freq_table[,4:59][is.na(all_pts_icd_freq_table[,4:59])] <- 0
```
...
write.csv(patients, "Z:/patients_20170712.csv")
